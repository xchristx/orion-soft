...
import AddReciboDetails from './AddReciboDetails';
          ...
          <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={1.5}>
              ...
              <Grid item xs={12} sm={4} sx={{ display: 'flex', alignItems: 'center' }}>
                <AddReciboDetails edit={!!watch('detalleVenta')?.length} setValue={setValue} setTotales={setTotales} />
              </Grid>
              <Grid item xs={12} sm={6}>
                <RHFTextField variant="filled" name="cliente" label="Cliente" />
              </Grid>
              <Grid item xs={12} sm={6}>
                <RHFTextField
                  variant="filled"
