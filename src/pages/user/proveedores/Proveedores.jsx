...
import AddEditStaffInfo from './components/AddEditProveedor';
import ClientesTableBody from './components/ProveedoresTableBody';
import RecordsLayout from '../../../layouts/dashboard/records/RecordsLayout';
// utils
import { TableBody, TableCell, TableRow } from '@mui/material';
import { resetFilteredData, setFilteredData } from '../../../redux/slices/proveedores';
...
const headLabel = [
  ...
  { id: 'producto', label: 'Producto Principal', alignRight: false },
...
const bcLinks = [
  ...
  { name: 'Proveedores', href: '/dashboard/usuario/proveedores' },
];

export default function Proveedores() {
  const { data, filteredData, filter, isLoading, error } = useSelector(state => state.proveedores);
  const {
    open,
    page,
    rowsPerPage,
  ...
  return (
    <RecordsLayout
      ...
      GTLabels={{ buttonLabel: 'Nuevo proveedor', bcTitle: 'Proveedores' }} // labels para el toolbar
      ...
      filterCells={['producto']} // introducir array de los ids de las colunmas que contendran la funcion de filtrado
      disableOptions={['email', 'notas', 'producto']} // array de las columnas que no tendran la opcion de ordenamiento
